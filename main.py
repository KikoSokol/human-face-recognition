...
def work_with_true_pairs():
    ...
    for pair in pairs:
        ...
        video_1_info = all.to_mp4(DIRECTORY_FOR_SAVE, directory_name, video_1_file_without_suffix, "ORIGINAL",
                                  video_1_file["colorImages"],
                                  video_1_file["landmarks2D"],
                                  video_1_file["boundingBox"])
        video_2_info = all.to_mp4(DIRECTORY_FOR_SAVE, directory_name, video_2_file_without_suffix, "ORIGINAL",
